                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employer.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('businessName') is-invalid @enderror" name="businessName" value="{{ old('businessName') }}" required autocomplete="businessName" autofocus>
